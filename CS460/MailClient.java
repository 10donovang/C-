...
*    Donovan Gregory
* Summary:
*    Sends serves as a server that can send messages from one user to another
*    and doesn't die if there is a problem.
************************************************************************** */
...
class SMTPConnection
{
   ...
   private int parseReply(String reply)
   {
      ...
      code = new Integer(replycode)).intValue();
      return code;
   }
